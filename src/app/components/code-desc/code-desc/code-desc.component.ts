...
export class CodeDescComponent implements OnInit {
  ...
  croppedImage: any = '';
  isStored = false;
  constructor(private formBuilder: FormBuilder, private __couponService: HarvestService) { 
    ...
    if (this.edit) {
      ...
      if (this.valForm.valid) {
        ...
        this.__couponService.create({
          ...
          if (data.result == "true") {
            swal({ icon: 'success', title: 'Cupón Guardado', text: 'El cupón fue creado exitosamenete.' });
          } else {
    ...
    swal({
      ...
      if (accepted) {
        this.__couponService.delete({
          ...
          swal({ icon: 'success', title: 'Cupón Eliminado', text: 'El Cupón fue eliminado exitosamenete.' });
          this.ngOnInit()
        }, e => {
    ...
    if (this.edit && $ev != 0) {
      ...
      if (this.valForm.valid) {
        ...
        this.__couponService.update({
          ...
          swal({ icon: 'success', title: 'Cupón Actualizado', text: 'El cupón fue actualizado exitosamenete.' });
